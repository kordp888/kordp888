...
**14 steps. One loop. Every product.**

## Stack

`AI Agents` `AI Agent Orchestration` `LLM Applications` `Local LLM (sLLM)` `MCP` `Python` `Firebase` `Supabase` `Vercel` `GA4 · GTM` `Figma`

Local models I run: Qwen · Gemma · Granite · EXAONE · DeepSeek
